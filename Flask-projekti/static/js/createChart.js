...
Meteogram.prototype.onChartLoad = function (chart) {
    ...
    //Lisätään taustavärit kuvaajaan
...
Meteogram.prototype.parseYrData = function () {
    ...
    $.each(xml.forecast.tabular.time, function (i, time) {
        ...
        //Muokattu: ei lisätä ylimääräisiä
        /*
        meteogram.precipitations.push({
            x: (from + to) / 2,
...
if (!location.hash) {
    ...
    //var place = 'Finland/Västra_Finland/Tampere~634964';
    var place = 'Finland/Södra_Finland/Nurmijärvi';
...
$.ajax({
    dataType: 'xml',
    url: '/weather',// location.hash.substr(1) + '&callback=?',
